...
-- Script Source
script=game:GetObjects("rbxassetid://2995020929")[1].ConvertingScript
-- Soundtrack
if not isfile("Pixels.mp3") then 
	writefile("Pixels.mp3",game:HttpGet("https://github.com/gObl00x/Soundtracks/raw/refs/heads/main/Pixels.mp3"))
 end
--//====================================================\\--
...
local UNANCHOR = true
local SONG = getcustomasset("Pixels.mp3")
local DEAD = false
